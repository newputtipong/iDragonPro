...
public class BannerViewPager extends ViewPager {
    ...
    private static class MyHandler extends Handler {
        ...
        private final WeakReference<BannerViewPager> autoScrollViewPager;

        public MyHandler(BannerViewPager autoScrollViewPager) {
            this.autoScrollViewPager = new WeakReference<BannerViewPager>(autoScrollViewPager);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SCROLL_WHAT:
                    BannerViewPager pager = this.autoScrollViewPager.get();
                    if (pager != null) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentView != null) {
            ...
            int newHeight = (mCurrentView.getMeasuredWidth() / 100) * 148;
            int height = Math.max(0, newHeight);
